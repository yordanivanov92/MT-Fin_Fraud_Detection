...
![Support vector classifier: Left plot shows the perfectly separable case. Right plot shows the nonseparable, or overlapping, case (Source: J. Friedman, Hastie, and Tibshirani 2001).](figures/svm.png){width=80%}
...
\center
![](figures/ucsd/ucsd_gbm_rocs.png){width=60%}\
**UCSD: GBM ROC Curves**

![](figures/ucsd/ucsd_gbm_PR.png){width=60%}\
**UCSD: GBM Precision-Recall Curves**

![](figures/ucsd/ucsd_glm_rocs.png){width=60%}\
**UCSD: Log. Regression ROC Curves**

![](figures/ucsd/ucsd_glm_PR.png){width=60%}\
**UCSD: Log. Regression Precision-Recall Curves**

![](figures/ucsd/ucsd_nnet_rocs.png){width=60%}\
**UCSD: ANN ROC Curves**

![](figures/ucsd/ucsd_nnet_PR.png){width=60%}\
**UCSD: ANN Precision-Recall Curves**

![](figures/ucsd/ucsd_randfor_rocs.png){width=60%}\
**UCSD: Random Forest ROC Curves**

![](figures/ucsd/ucsd_randfor_PR.png){width=60%}\
**UCSD: Random Forest Precision-Recall Curves**

![](figures/ucsd/ucsd_svm_rocs.png){width=60%}\
**UCSD: SVM ROC Curves**

![](figures/ucsd/ucsd_svm_PR.png){width=60%}\
**UCSD: SVM Precision-Recall Curves**

![](figures/ucsd/ucsd_xgboost_rocs.png){width=60%}\
**UCSD: xGBoost ROC Curves**

![](figures/ucsd/ucsd_xgboost_PR.png){width=60%}\
