...
(Ngai et al. 2011). Some of the most common classification techniques
include logistic regression, neural networks, support vector machine and
...
which contains only a single hidden layer. The model can be extended to
