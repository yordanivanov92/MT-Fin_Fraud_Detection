...
analytics_table <- data.frame ("Forensic Data" = c("Spreadsheet tools such as MS Excel",
                                                   ...
                                                   "Continious monitoring tools, which may include                                                           governance risk and compliance (GRC) tools (SAP,                                                         Oracle, SAI Global)",
                               ...
                               "Percent" = c("65%", "43%", "29%", 
                                             ...
                                             "12%", "11%", "2%", 
                                             "2%"))
kable(analytics_table, format = "markdown")
```
