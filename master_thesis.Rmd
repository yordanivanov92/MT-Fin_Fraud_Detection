...
Among the more complex and successful methods for fraud reduction are machine learning techniques [@chaudhary2012credit]. Among the techniques most used for credit card are logistic regression, support vector machines, neural networks, bayesian networks, cluster methods and different tree models [@ngai2011application; @bhattacharyya2011data; @chaudhary2012credit].
