...
nnet_results <- predict(bankSim_orig_fit, newdata = bankSim_test)
confusionMatrix(nnet_results, bankSim_test$fraud)
...
nnet_results_weighted <- predict(bankSim_weighted_fit, newdata = bankSim_test)
confusionMatrix(nnet_results_weighted, bankSim_test$fraud)
...
nnet_results_down <- predict(bankSim_down_fit, newdata = bankSim_test)
confusionMatrix(nnet_results_down, bankSim_test$fraud)
...
nnet_results_up <- predict(bankSim_up_fit, newdata = bankSim_test)
confusionMatrix(nnet_results_up, bankSim_test$fraud)
...
nnet_results_smote <- predict(bankSim_smote_fit, newdata = bankSim_test)
confusionMatrix(nnet_results_smote, bankSim_test$fraud)
